  ...
  <div class="row justify-content-center">
    <div class="col-10">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="myappApp.travelPlanStartForm.home.createOrEditLabel"
          data-cy="TravelPlanStartFormCreateUpdateHeading"
          v-text="$t('myappApp.travelPlanStartForm.home.createOrEditLabel')"
        >
            ...
            <template v-slot:body>
              ...
              <div v-if="travelPlanProcess.travelPlan">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanStartForm.name')" for="travel-plan-start-form-name"
                    >Name</label
                  >
                  <input
                    type="text"
                ...
                <div class="form-group">
                  <label
                    ...
                    v-text="$t('myappApp.travelPlanStartForm.startDate')"
                ...
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanStartForm.endDate')" for="travel-plan-start-form-endDate"
                    >End Date</label
                  >
                  <b-input-group class="mb-3">
                    <b-input-group-prepend>
