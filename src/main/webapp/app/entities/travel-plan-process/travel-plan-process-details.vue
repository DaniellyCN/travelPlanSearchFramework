    ...
    <div class="col-10">
      <div v-if="travelPlanProcess.processInstance">
        <h2 class="jh-entity-heading" data-cy="travelPlanProcessDetailsHeading">
          <span v-text="$t('myappApp.travelPlanProcess.detail.title')">TravelPlanProcess</span> {{ travelPlanProcess.id }}
        </h2>
            ...
            <div class="card" v-if="travelPlanProcess.travelPlan">
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanProcess.name')">name</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanProcess.startDate')">startDate</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanProcess.endDate')">endDate</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanProcess.airlineCompanyName')">airlineCompanyName</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanProcess.airlineTicketNumber')"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanProcess.hotelName')">hotelName</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanProcess.hotelBookingNumber')">hotelBookingNumber</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanProcess.carCompanyName')">carCompanyName</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('myappApp.travelPlanProcess.carBookingNumber')">carBookingNumber</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
