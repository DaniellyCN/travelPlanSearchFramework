        ...
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskCar.name')" for="task-car-name">Name</label>
              <input
                type="text"
                class="form-control"
                name="name"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskCar.startDate')" for="task-car-startDate">Start Date</label>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskCar.endDate')" for="task-car-endDate">End Date</label>
              <b-input-group class="mb-3">
                <b-form-input
                  id="task-car-endDate"
                  readonly
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskCar.carCompanyName')" for="task-car-carCompanyName"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskCar.carBookingNumber')" for="task-car-carBookingNumber"
